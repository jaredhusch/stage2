...
user_input = raw_input("Please choose a difficulty level: easy, medium, or hard.")

#Takes user input to determine the level and prints out level questions
...
# Takes user input and returns level answers
